                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header border-0 align-items-center d-flex pb-0">
                                <h4 class="card-title mb-0 flex-grow-1">Modify category status</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <?= form_open('home/update_category_status') ?>
<div class="row">
    <div class="col-md-6">
        <div class="form-floating mb-3">
            <select class="form-select" id="floatingSelectGrid" name="cate_id" required>
