...
<section class="tp-login-area pb-140 p-relative z-index-1 fix">
   ...
   <?=form_open()?>
      <div class="row justify-content-center">
         <div class="col-xl-6 col-lg-8"><br>
            <div class="tp-login-wrapper">
               <div class="tp-login-top text-center mb-30">
                  <h3 class="tp-login-title">Sign Up Shoclusive</h3>
               ...
               <div class="tp-login-option">
                  ...
                  <div class="tp-login-input-wrapper">
                     ...
                     <div class="tp-login-input-box">
                        <div class="tp-login-input">
                           <input id="email" name="email" type="email" placeholder="yourmail@domain.com">
                        </div>
                        <div class="tp-login-input-title">
                  ...
                  <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20">
                     <div class="">
                        ...
                        <label>By signup you are accepting our <a href="pages/privacy">Privacy Policy</a>.</label>
                        <br><?=form_error('check')?>
                     </div>
                  </div>
                  <div class="tp-login-bottom">
                     <button type="submit" href="#" class="tp-login-btn w-100">Create acount</button>
                  </div>
               </div>
            </div>
         </div>
