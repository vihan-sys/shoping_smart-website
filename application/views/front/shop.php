                              ...
                              <div class="tab-pane fade show active" id="grid-tab-pane" role="tabpanel" aria-labelledby="grid-tab" tabindex="0">
                                 <div class="row infinite-container">
                                    ...
                                    <?php foreach ($products as $arr):
                                        $cate_name = $this->shopModel->category_name($arr->category);
                                        ?>
                                       ...
                                       <div class="tp-product-item-2 mb-40">
                                          ...
                                          <div class="tp-product-content-2 pt-15">
                                             ...
                                             <h3 class="tp-product-title-2">
                                                <a href="product/<?=$arr->slug?>"><?=ellipsize($arr->pro_name,80)?></a>
                                             </h3>
                                             <div class="tp-product-price-wrapper-2">
                                                <span class="tp-product-price-2 new-price" style="font-size: 18px;">₹<?=number_format($arr->selling_price)?></span>
                                                <span class="tp-product-price-2 old-price" style="font-size: 16px; padding-left: 10px;">₹<?=number_format($arr->mrp)?></span>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
